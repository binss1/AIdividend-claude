...
export const demoETFs: ScreenedETF[] = [
  {
    ...
    price: 82.45, aum: 62800000000, expenseRatio: 0.0006,
    dividendYield: 0.0348, beta: 0.82, holdingsCount: 103,
    qualityScore: 92, liquidityScore: 95, exposureScore: 85, dividendScore: 88,
    totalScore: 90, qualityGrade: 'A+', liquidityGrade: 'A+',
    exposureGrade: 'A', dividendGrade: 'A',
    isCoveredCall: false,
    top10Holdings: [],
  },
  {
    symbol: 'VYM', name: 'Vanguard High Dividend Yield ETF',
    price: 121.32, aum: 55400000000, expenseRatio: 0.0006,
    dividendYield: 0.0285, beta: 0.78, holdingsCount: 536,
    qualityScore: 88, liquidityScore: 94, exposureScore: 90, dividendScore: 82,
    totalScore: 88, qualityGrade: 'A', liquidityGrade: 'A+',
    exposureGrade: 'A+', dividendGrade: 'A',
    isCoveredCall: false,
    top10Holdings: [],
  },
  {
    ...
    price: 112.86, aum: 10800000000, expenseRatio: 0.0008,
    dividendYield: 0.0372, beta: 0.72, holdingsCount: 75,
    qualityScore: 85, liquidityScore: 88, exposureScore: 78, dividendScore: 90,
    totalScore: 85, qualityGrade: 'A', liquidityGrade: 'A',
    exposureGrade: 'B+', dividendGrade: 'A+',
    isCoveredCall: false,
    top10Holdings: [],
  },
  {
    symbol: 'JEPI', name: 'JPMorgan Equity Premium Income ETF',
    price: 57.42, aum: 35600000000, expenseRatio: 0.0035,
    dividendYield: 0.0715, beta: 0.55, holdingsCount: 130,
    qualityScore: 82, liquidityScore: 92, exposureScore: 72, dividendScore: 95,
    totalScore: 84, qualityGrade: 'A', liquidityGrade: 'A+',
    exposureGrade: 'B+', dividendGrade: 'A+',
    isCoveredCall: true,
    top10Holdings: [],
  },
  {
    ...
    price: 58.92, aum: 27300000000, expenseRatio: 0.0008,
    dividendYield: 0.0228, beta: 0.85, holdingsCount: 420,
    qualityScore: 90, liquidityScore: 90, exposureScore: 88, dividendScore: 75,
    totalScore: 83, qualityGrade: 'A+', liquidityGrade: 'A',
    exposureGrade: 'A', dividendGrade: 'B+',
    isCoveredCall: false,
    top10Holdings: [],
  },
  {
    symbol: 'JEPQ', name: 'JPMorgan Nasdaq Equity Premium Income ETF',
    price: 52.18, aum: 18900000000, expenseRatio: 0.0035,
    dividendYield: 0.0942, beta: 0.65, holdingsCount: 85,
    qualityScore: 78, liquidityScore: 88, exposureScore: 68, dividendScore: 96,
    totalScore: 82, qualityGrade: 'B+', liquidityGrade: 'A',
    exposureGrade: 'B', dividendGrade: 'A+',
    isCoveredCall: true,
    top10Holdings: [],
  },
  {
    ...
    price: 36.72, aum: 3500000000, expenseRatio: 0.0055,
    dividendYield: 0.0465, beta: 0.68, holdingsCount: 25,
    qualityScore: 80, liquidityScore: 72, exposureScore: 65, dividendScore: 88,
    totalScore: 76, qualityGrade: 'A', liquidityGrade: 'B+',
    exposureGrade: 'B', dividendGrade: 'A',
    isCoveredCall: true,
    top10Holdings: [],
  },
  {
    ...
    price: 42.86, aum: 7800000000, expenseRatio: 0.0007,
    dividendYield: 0.0412, beta: 0.88, holdingsCount: 80,
    qualityScore: 74, liquidityScore: 85, exposureScore: 82, dividendScore: 85,
    totalScore: 80, qualityGrade: 'B+', liquidityGrade: 'A',
    exposureGrade: 'A', dividendGrade: 'A',
    isCoveredCall: false,
    top10Holdings: [],
  },
